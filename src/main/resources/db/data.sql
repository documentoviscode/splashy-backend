...
VALUES  (7,2,'<GLinkDrive10>','2023-10-29','2023-10-30',1,69.99),
        (8,3,'<GLinkDrive11>','2023-10-28','2023-11-01',2,13.37),
        (9,4,'<GLinkDrive12>','2023-10-27','2023-11-02',3,21.37);

INSERT INTO Monthly_Reports(id, type, GDrive_Link, creation_date,start_date,end_date,viewers,hours_watched,donations)
VALUES  (7,2,'<GLinkDrive13>','2023-01-01','2023-09-01','2023-09-30',1111,45649.5,123123),
        (8,3,'<GLinkDrive14>','2023-10-01','2023-09-01','2023-09-30',20332,123333.3,3455),
        (9,4,'<GLinkDrive15>','2023-10-01','2023-09-01','2023-09-30',2137,69000.5,666);
